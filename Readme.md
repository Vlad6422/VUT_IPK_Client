...
This version organizes the sections more logically, includes additional details for clarity, and maintains consistency throughout. Let me know if you need any modifications! 🚀
# IPK25-CHAT Theory
...
- **Reference Server Output**:  
  ![Reference Server Output](tests\IntegrationReferenceServerTests\ReferenceServerResult\TCP\AUTH\ReferenceServerAUTH.png)
- **Wireshark Screenshot**:  
  ![Wireshark](tests\IntegrationReferenceServerTests\ReferenceServerResult\TCP\AUTH\WiresharkAUTH.png)
...
- **Reference Server Output**:  
  ...
  ![Reference Server Output](tests\IntegrationReferenceServerTests\ReferenceServerResult\TCP\JOIN\ReferenceServerJOIN.png)
  Connected To discord.jointest.
  ![Reference Server Output1](tests\IntegrationReferenceServerTests\ReferenceServerResult\TCP\JOIN\ReferenceJOIN1.png)
 `Here is strange thing of Reference Server. TCP was tested after UDP. So it Created new channel for TCP (Upper Image), but prints MSG to old one channel with the same name.(That channel was created for UDP)`
  ![Reference Server Output2](tests\IntegrationReferenceServerTests\ReferenceServerResult\TCP\JOIN\ReferenceServerJOIN3.png)
- **Wireshark Screenshot**:  
  ![Wireshark](tests\IntegrationReferenceServerTests\ReferenceServerResult\TCP\JOIN\WiresharkJOIN.png)
- **Wireshark FLOW**: 
```
...
- **Program Output**: The output generated by the system during the test.
- **Reference Server Output**:  
  ![Reference Server Output](tests\IntegrationReferenceServerTests\ReferenceServerResult\TCP\RENAME\ReferenceServerRENAME.png)
- **Wireshark Screenshot**:  
  ![Wireshark](tests\IntegrationReferenceServerTests\ReferenceServerResult\TCP\RENAME/Wireshark.png)
- **Wireshark pcapng**: Captured network traffic during the test.
```
...
- **Program Output**: The output generated by the system during the test.
- **Reference Server Output**:  
  ![Reference Server Output](tests\IntegrationReferenceServerTests\ReferenceServerResult\UDP\AUTH\ReferenceServerAUTH.png)
- **Wireshark Screenshot**:  
  ![Wireshark](tests\IntegrationReferenceServerTests\ReferenceServerResult\UDP\AUTH\WiresharkAUTH.png)
- **Wireshark pcapng**: Captured network traffic during the test.
...
- **Program Output**: The output generated by the system during the test.
- **Reference Server Output**:  
  ![Reference Server Output](tests\IntegrationReferenceServerTests\ReferenceServerResult\UDP\BYE\ReferenceServerBYE.png)
- **Wireshark Screenshot**:  
  ![Wireshark](tests\IntegrationReferenceServerTests\ReferenceServerResult\UDP\BYE\WiresharkBYE.png)
- **Wireshark pcapng**: Captured network traffic during the test.
...
- **Program Output**: The output generated by the system during the test.
- **Reference Server Output**:  
  ![Reference Server Output](tests\IntegrationReferenceServerTests\ReferenceServerResult\UDP\JOIN\ReferenceServerJOIN.png)
- **Wireshark Screenshot**:  
  ![Wireshark](tests\IntegrationReferenceServerTests\ReferenceServerResult\UDP\JOIN\WiresharkJOIN.png)
- **Wireshark pcapng**: Captured network traffic during the test.
...
- **Program Output**: The output generated by the system during the test.
- **Reference Server Output**:  
  ![Reference Server Output](tests\IntegrationReferenceServerTests\ReferenceServerResult\UDP\MSG\ReferenceServerMSG.png)
- **Wireshark Screenshot**:  
  ![Wireshark](tests\IntegrationReferenceServerTests\ReferenceServerResult\UDP\MSG\WiresharkMSG.png)
- **Wireshark pcapng**: Captured network traffic during the test.
...
- **Program Output**: The output generated by the system during the test.
- **Reference Server Output**:  
  ![Reference Server Output](tests\IntegrationReferenceServerTests\ReferenceServerResult\UDP\RENAME\ReferenceServerRENAME.png)
- **Wireshark Screenshot**:  
  ![Wireshark](tests\IntegrationReferenceServerTests\ReferenceServerResult\UDP\RENAME\WiresharkRENAME.png)
- **Wireshark pcapng**: Captured network traffic during the test.
...
#### Visuals  
![Wireshark](tests/CustomServer/Result.png)
